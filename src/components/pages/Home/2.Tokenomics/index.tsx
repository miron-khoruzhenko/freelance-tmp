...
const Tokenomics = () => {
	...
	return (
		<section className='bg-tokenomics bg-center bg-cover bg-no-repeat min-h-screen'>
			...
			<div className="relative w-[1000px] lg:w-auto">
				<img src={cloud} alt="" className="" />
				<div className=" absolute top-1/2 left-1/2 translate-y-[180px] lg:translate-y-[220px] -translate-x-1/2 w-[300px] flex justify-start items-center gap-4">
					<Card className='flex items-center justify-center p-2 bg-[#D8C5FF]'>70%</Card>
					<Card className='p-2'>Lorem Ipsum is simply dummy</Card>
				</div>
				<div className=" absolute top-1/2 left-1/2 translate-y-[120px] lg:translate-y-[160px] -translate-x-[calc(50%+400px)] w-[300px] flex justify-start items-center gap-4">
				<Card className='flex items-center justify-center p-2 bg-[#D8C5FF]'>70%</Card>
				<Card className='p-2'>Lorem Ipsum is simply dummy</Card>
				</div>
				<div className=" absolute top-1/2 left-1/2 translate-y-[230px] lg:translate-y-[280px] -translate-x-[calc(50%-410px)] w-[300px] flex justify-start items-center gap-4">
				<Card className='flex items-center justify-center p-2 bg-[#D8C5FF]'>70%</Card>
				<Card className='p-2'>Lorem Ipsum is simply dummy</Card>
				</div>
			</div>
